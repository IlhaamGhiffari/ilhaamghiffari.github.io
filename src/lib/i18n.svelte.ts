...
const dict: Record<Lang, Record<string, string>> = {
	en: {
		...
		'about.big1': 'Built to ship,',
		'about.big2': 'not to',
		'about.big3': 'screenshot.',
	...
	id: {
		...
		'about.big1': 'Dibuat untuk rilis,',
		'about.big2': 'bukan untuk',
		'about.big3': 'pamer layar.',
		...
		'work.head1': 'Proyek pilihan · 01',
		'contact.h1': 'Ada proyek,',
		'contact.h2': 'atau info lowongan?',
		'term.welcome1': 'ilhaam · platform engineer',
		'term.welcome2': 'resume 2026 · shell interaktif',
