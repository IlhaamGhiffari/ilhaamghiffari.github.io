...
const dict: Record<Lang, Record<string, string>> = {
	en: {
		...
		'about.p1': "I'm Ilhaam — a platform engineer with a S.Kom in Informatics from Universitas Syiah Kuala (GPA 3.77). I build cloud infrastructure that ships: Terraform, Kubernetes, GitOps with ArgoCD, CI/CD secured by OIDC, and observability on top.",
	...
	id: {
		...
		'about.p1': 'Saya Ilhaam — platform engineer, S.Kom Informatika Universitas Syiah Kuala (IPK 3.77). Saya membangun infrastruktur cloud yang benar-benar berjalan: Terraform, Kubernetes, GitOps dengan ArgoCD, CI/CD yang diamankan OIDC, dan observability di atasnya.',
